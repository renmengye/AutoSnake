...
public class AutoSnakeAboutBox extends javax.swing.JDialog {

    public AutoSnakeAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(autosnake.AutoSnakeApp.class).getContext().getResourceMap(AutoSnakeAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(autosnake.AutoSnakeApp.class).getContext().getActionMap(AutoSnakeAboutBox.class, this);
